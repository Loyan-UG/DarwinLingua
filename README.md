...
- `Phase 3 enhanced lexical intelligence`: `In Progress`
  - lexical usage/context labels, grammar notes, collocations, and word families now flow from imported content into a richer word-detail screen, while lexical relations remain next
- `Phases 4-5`: `Planned`
