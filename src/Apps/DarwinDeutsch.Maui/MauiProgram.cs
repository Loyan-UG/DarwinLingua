...
public static class MauiProgram
{
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services
            ...
            .AddSingleton<IWordCollectionBrowseStateService, WordCollectionBrowseStateService>()
            ...
            .AddSingleton<LearningPortalPage>()
            .AddTransient<LearningPortalListPage>()
            .AddTransient<LearningPortalDetailPage>()
            .AddTransient<LearningPortalSearchPage>()
            ...
            .AddTransient<CollectionsPage>()
            .AddTransient<CollectionWordsPage>()
            .AddTransient<DialoguesPage>()
            .AddTransient<DialogueDetailPage>()
            .AddTransient<ConversationStartersPage>()
            .AddTransient<ConversationStarterDetailPage>()
            .AddTransient<EventPreparationPackDetailPage>()
