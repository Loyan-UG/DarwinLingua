    ...
    ILogger<RemoteContentUpdateService> logger) : IRemoteContentUpdateService
{
    ...
    private const string FullReplaceScript =
        ...
        DELETE FROM DialogueTurnTranslations;
        DELETE FROM DialoguePhraseTranslations;
        DELETE FROM DialogueQuestionTranslations;
        DELETE FROM DialogueAnswerTranslations;
        DELETE FROM DialogueSpeakingPromptTranslations;
        DELETE FROM DialogueTurns;
        DELETE FROM DialoguePhrases;
        DELETE FROM DialogueAnswers;
        DELETE FROM DialogueQuestions;
        DELETE FROM DialogueSpeakingPrompts;
        DELETE FROM DialogueUsefulWords;
        DELETE FROM DialogueSpeakingFunctions;
        DELETE FROM DialogueSkillFocus;
        DELETE FROM DialogueExamProfiles;
        DELETE FROM DialogueLessonTopics;
        DELETE FROM DialogueLessons;
        DELETE FROM ConversationStarterPhraseTranslations;
        DELETE FROM ConversationStarterPhraseAlternatives;
        DELETE FROM ConversationStarterPhrases;
        DELETE FROM ConversationStarterLinkedEventPreparationPacks;
        DELETE FROM ConversationStarterLinkedDialogues;
        DELETE FROM ConversationStarterPackTopics;
        DELETE FROM ConversationStarterPacks;
        DELETE FROM EventPreparationPrompts;
        DELETE FROM EventPreparationVocabularyReferences;
        DELETE FROM EventPreparationLinkedConversationStarterPacks;
        DELETE FROM EventPreparationLinkedDialogues;
        DELETE FROM EventPreparationPackTopics;
        DELETE FROM EventPreparationPacks;
        DELETE FROM TalkTopicArticleTranslations;
        DELETE FROM TalkTopicQuestionTranslations;
        DELETE FROM TalkTopicQuestions;
        DELETE FROM TalkTopicSpeakingGoals;
        DELETE FROM TalkTopicTopics;
        DELETE FROM TalkTopicVocabularyItems;
        DELETE FROM TalkTopics;
        DELETE FROM GrammarSectionTranslations;
        DELETE FROM GrammarExampleTranslations;
        DELETE FROM GrammarCommonMistakeTranslations;
        DELETE FROM GrammarRuleSummaryTranslations;
        DELETE FROM GrammarExceptionNoteTranslations;
        DELETE FROM GrammarSections;
        DELETE FROM GrammarExamples;
        DELETE FROM GrammarCommonMistakes;
        DELETE FROM GrammarRuleSummaries;
        DELETE FROM GrammarExceptionNotes;
        DELETE FROM GrammarLinkedDialogues;
        DELETE FROM GrammarLinkedExercises;
        DELETE FROM GrammarLinkedTalkTopics;
        DELETE FROM GrammarLinkedWords;
        DELETE FROM GrammarPrerequisiteLinks;
        DELETE FROM GrammarRelatedTopicLinks;
        DELETE FROM GrammarTopicTopics;
        DELETE FROM GrammarTopics;
        DELETE FROM ExpressionExampleTranslations;
        DELETE FROM ExpressionWarningTranslations;
        DELETE FROM ExpressionExamples;
        DELETE FROM ExpressionWarnings;
        DELETE FROM ExpressionLinkedExercises;
        DELETE FROM ExpressionLinkedWords;
        DELETE FROM ExpressionMeanings;
        DELETE FROM ExpressionTopics;
        DELETE FROM RelatedExpressionLinks;
        DELETE FROM ExpressionEntries;
        DELETE FROM ExerciseSetItems;
        DELETE FROM ExerciseSets;
        DELETE FROM Exercises;
        DELETE FROM CourseLessons;
        DELETE FROM CourseModules;
        DELETE FROM CoursePaths;
        DELETE FROM WritingTemplates;
        DELETE FROM CulturalNotes;
        DELETE FROM ExamPrepUnits;
        DELETE FROM ExamProfiles;
        ...
        INSERT INTO DialogueLessons SELECT * FROM remote.DialogueLessons;
        INSERT INTO DialogueExamProfiles SELECT * FROM remote.DialogueExamProfiles;
        INSERT INTO DialogueSkillFocus SELECT * FROM remote.DialogueSkillFocus;
        INSERT INTO DialogueSpeakingFunctions SELECT * FROM remote.DialogueSpeakingFunctions;
        INSERT INTO DialogueUsefulWords SELECT * FROM remote.DialogueUsefulWords;
        INSERT INTO DialogueSpeakingPrompts SELECT * FROM remote.DialogueSpeakingPrompts;
        INSERT INTO DialogueSpeakingPromptTranslations SELECT * FROM remote.DialogueSpeakingPromptTranslations;
        INSERT INTO DialogueLessonTopics SELECT * FROM remote.DialogueLessonTopics;
        INSERT INTO DialogueTurns SELECT * FROM remote.DialogueTurns;
        INSERT INTO DialogueTurnTranslations SELECT * FROM remote.DialogueTurnTranslations;
        INSERT INTO DialoguePhrases SELECT * FROM remote.DialoguePhrases;
        INSERT INTO DialoguePhraseTranslations SELECT * FROM remote.DialoguePhraseTranslations;
        INSERT INTO DialogueQuestions SELECT * FROM remote.DialogueQuestions;
        INSERT INTO DialogueQuestionTranslations SELECT * FROM remote.DialogueQuestionTranslations;
        INSERT INTO DialogueAnswers SELECT * FROM remote.DialogueAnswers;
        INSERT INTO DialogueAnswerTranslations SELECT * FROM remote.DialogueAnswerTranslations;
        INSERT INTO ConversationStarterPacks SELECT * FROM remote.ConversationStarterPacks;
        INSERT INTO ConversationStarterPackTopics SELECT * FROM remote.ConversationStarterPackTopics;
        INSERT INTO ConversationStarterLinkedDialogues SELECT * FROM remote.ConversationStarterLinkedDialogues;
        INSERT INTO ConversationStarterLinkedEventPreparationPacks SELECT * FROM remote.ConversationStarterLinkedEventPreparationPacks;
        INSERT INTO ConversationStarterPhrases SELECT * FROM remote.ConversationStarterPhrases;
        INSERT INTO ConversationStarterPhraseTranslations SELECT * FROM remote.ConversationStarterPhraseTranslations;
        INSERT INTO ConversationStarterPhraseAlternatives SELECT * FROM remote.ConversationStarterPhraseAlternatives;
        INSERT INTO EventPreparationPacks SELECT * FROM remote.EventPreparationPacks;
        INSERT INTO EventPreparationPackTopics SELECT * FROM remote.EventPreparationPackTopics;
        INSERT INTO EventPreparationLinkedDialogues SELECT * FROM remote.EventPreparationLinkedDialogues;
        INSERT INTO EventPreparationLinkedConversationStarterPacks SELECT * FROM remote.EventPreparationLinkedConversationStarterPacks;
        INSERT INTO EventPreparationVocabularyReferences SELECT * FROM remote.EventPreparationVocabularyReferences;
        INSERT INTO EventPreparationPrompts SELECT * FROM remote.EventPreparationPrompts;
        INSERT INTO TalkTopics SELECT * FROM remote.TalkTopics;
        INSERT INTO TalkTopicArticleTranslations SELECT * FROM remote.TalkTopicArticleTranslations;
        INSERT INTO TalkTopicQuestions SELECT * FROM remote.TalkTopicQuestions;
        INSERT INTO TalkTopicQuestionTranslations SELECT * FROM remote.TalkTopicQuestionTranslations;
        INSERT INTO TalkTopicSpeakingGoals SELECT * FROM remote.TalkTopicSpeakingGoals;
        INSERT INTO TalkTopicTopics SELECT * FROM remote.TalkTopicTopics;
        INSERT INTO TalkTopicVocabularyItems SELECT * FROM remote.TalkTopicVocabularyItems;
        INSERT INTO GrammarTopics SELECT * FROM remote.GrammarTopics;
        INSERT INTO GrammarTopicTopics SELECT * FROM remote.GrammarTopicTopics;
        INSERT INTO GrammarSections SELECT * FROM remote.GrammarSections;
        INSERT INTO GrammarSectionTranslations SELECT * FROM remote.GrammarSectionTranslations;
        INSERT INTO GrammarExamples SELECT * FROM remote.GrammarExamples;
        INSERT INTO GrammarExampleTranslations SELECT * FROM remote.GrammarExampleTranslations;
        INSERT INTO GrammarCommonMistakes SELECT * FROM remote.GrammarCommonMistakes;
        INSERT INTO GrammarCommonMistakeTranslations SELECT * FROM remote.GrammarCommonMistakeTranslations;
        INSERT INTO GrammarRuleSummaries SELECT * FROM remote.GrammarRuleSummaries;
        INSERT INTO GrammarRuleSummaryTranslations SELECT * FROM remote.GrammarRuleSummaryTranslations;
        INSERT INTO GrammarExceptionNotes SELECT * FROM remote.GrammarExceptionNotes;
        INSERT INTO GrammarExceptionNoteTranslations SELECT * FROM remote.GrammarExceptionNoteTranslations;
        INSERT INTO GrammarPrerequisiteLinks SELECT * FROM remote.GrammarPrerequisiteLinks;
        INSERT INTO GrammarRelatedTopicLinks SELECT * FROM remote.GrammarRelatedTopicLinks;
        INSERT INTO GrammarLinkedWords SELECT * FROM remote.GrammarLinkedWords;
        INSERT INTO GrammarLinkedDialogues SELECT * FROM remote.GrammarLinkedDialogues;
        INSERT INTO GrammarLinkedTalkTopics SELECT * FROM remote.GrammarLinkedTalkTopics;
        INSERT INTO GrammarLinkedExercises SELECT * FROM remote.GrammarLinkedExercises;
        INSERT INTO ExpressionEntries SELECT * FROM remote.ExpressionEntries;
        INSERT INTO ExpressionTopics SELECT * FROM remote.ExpressionTopics;
        INSERT INTO ExpressionMeanings SELECT * FROM remote.ExpressionMeanings;
        INSERT INTO ExpressionExamples SELECT * FROM remote.ExpressionExamples;
        INSERT INTO ExpressionExampleTranslations SELECT * FROM remote.ExpressionExampleTranslations;
        INSERT INTO ExpressionWarnings SELECT * FROM remote.ExpressionWarnings;
        INSERT INTO ExpressionWarningTranslations SELECT * FROM remote.ExpressionWarningTranslations;
        INSERT INTO ExpressionLinkedWords SELECT * FROM remote.ExpressionLinkedWords;
        INSERT INTO RelatedExpressionLinks SELECT * FROM remote.RelatedExpressionLinks;
        INSERT INTO ExpressionLinkedExercises SELECT * FROM remote.ExpressionLinkedExercises;
        INSERT INTO Exercises SELECT * FROM remote.Exercises;
        INSERT INTO ExerciseSets SELECT * FROM remote.ExerciseSets;
        INSERT INTO ExerciseSetItems SELECT * FROM remote.ExerciseSetItems;
        INSERT INTO CoursePaths SELECT * FROM remote.CoursePaths;
        INSERT INTO CourseModules SELECT * FROM remote.CourseModules;
        INSERT INTO CourseLessons SELECT * FROM remote.CourseLessons;
        INSERT INTO WritingTemplates SELECT * FROM remote.WritingTemplates;
        INSERT INTO CulturalNotes SELECT * FROM remote.CulturalNotes;
        INSERT INTO ExamProfiles SELECT * FROM remote.ExamProfiles;
        INSERT INTO ExamPrepUnits SELECT * FROM remote.ExamPrepUnits;
