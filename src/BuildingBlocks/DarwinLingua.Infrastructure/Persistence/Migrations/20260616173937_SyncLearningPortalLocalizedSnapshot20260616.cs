...
public partial class SyncLearningPortalLocalizedSnapshot20260616 : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql(
            ...
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "TitleTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "ShortDescriptionTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "SensitivityWarningTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "SectionsTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "ExamplesTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "DontNotesTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "DoNotesTranslationsJson";
            ALTER TABLE "CountryGuidanceNotes" DROP COLUMN IF EXISTS "ContextTranslationsJson";
