...
- BAMF online test center / question catalog: keep the test-form and catalog numbers separate. The BAMF 2026 Abschlusspruefung page states that each real LiD test sheet has 33 questions, 60 minutes, 15 correct answers to pass, and 17 correct answers for citizenship-relevant civic-knowledge proof. The same page says the interactive online catalog shows the answers for each of 310 questions. The separate BAMF downloadable Gesamtfragenkatalog page, dated 2025-05-26, describes the full catalog as 300 federal questions plus 160 federal-state-specific questions. Because BAMF surfaces can describe the interactive catalog and the downloadable full catalog differently, product content must avoid hard-coding one global total as learner-facing copy unless the exact source and review date are shown. We may teach the concepts, but should not turn the app into a copied official question bank.
  Sources: https://www.bamf.de/DE/Themen/Integration/ZugewanderteTeilnehmende/Integrationskurse/Abschlusspruefung/abschlusspruefung-node.html, https://www.bamf.de/SharedDocs/Anlagen/DE/Integration/Einbuergerung/gesamtfragenkatalog-lebenindeutschland.html, and https://oet.bamf.de/ords/oetut/f?p=534:1
...
- Cannabis law: since 2024, cannabis is no longer handled as a narcotic in the same way, but only limited adult possession/cultivation is allowed. Content must explain that "legal" does not mean unrestricted: age, quantity, cultivation, consumption near minors/schools/playgrounds/sports facilities/pedestrian zones, sharing with others, clubs, traffic, and local rules matter. Current official BMG FAQ wording reviewed on 2026-06-20 states 25 g carried in public, 50 g at home, up to three plants for adults, continued prohibition for minors, stricter consequences for transfer to minors, and administrative-offence/criminal-law thresholds when quantities exceed the permitted limits. Do not give learners exact legal advice from memory; cite the review date if exact quantities appear in app content.
...
- Test orientation: Orientierungskurs purpose, DTZ/LiD relationship, 33 questions, 60 minutes, 15/17-point distinction, the difference between BAMF interactive catalog wording and the downloadable Gesamtfragenkatalog totals, and why concept understanding matters more than memorization.
