...
- Desktop installability baseline evidence is generated by `tools/Web/New-WebPwaInstallabilityReport.ps1`; the 2026-06-23 public-domain report at `artifacts/validation/pwa-installability/pwa-installability-darwinlingua-20260623.json` passed 17 automated checks and left 2 manual checks for real install prompt acceptance on desktop Chrome/Edge and Android Chrome.
