...
- `70-Roleplay-Content-Package-Contract.md` defines the Phase 6 scripted roleplay contract, role labels, turn sequence model, answer choices, static feedback, and AI boundary. It also records that standalone RoleplayScenario packages are blocked until parser/import/persistence/Web/search/admin/test support exists.
