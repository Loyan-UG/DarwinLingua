...
- Phase 3 has now started with the first mobile-focused lexical-intelligence slices: imported usage/context labels, learner-facing grammar notes, and collocations persist on `WordEntry`, flow through `GetWordDetails`, and render in an upgraded word-detail screen.
...
2. Continue Phase 3 with the next lexical-intelligence slice, preferably word families or lexical relations on the upgraded word-detail screen.
...
- Prioritize the next Phase 3 mobile lexical-intelligence slice after the implemented usage/context labels, grammar notes, and collocations, preferably word families or lexical relations on the upgraded word-detail screen.
