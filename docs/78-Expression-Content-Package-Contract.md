...
All source fields must be authored natively in the package target language and pragmatic context. Future English, Spanish, or French expression packages must be new source content for those languages, not translated copies of German expressions.
