...
All source fields must be authored natively in the package target language. Future English, Spanish, or French event-preparation packages must be new source content for those languages, not translated copies of German packs.
