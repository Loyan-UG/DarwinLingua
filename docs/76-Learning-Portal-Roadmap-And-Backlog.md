...
4. Invite the first controlled Web testers using `artifacts/validation/web-tester-runs/20260623-172706-web-tester-pass-brevo-ready/TesterQuickStart.md`, keep `ManualExternalReviewChecklist.md` operator-only, collect observations in that bundle's `WebTesterFeedback.csv`, and run the triage helper before new bulk content work.
