...
- [ ] Add authenticated eligibility tests for future rude/slang preference and adult-access profile states.
- [ ] Add mobile export tests proving adult-only Expressions are excluded until mobile eligibility enforcement exists.
