# Darwin Deutsch Talk Topics A1-A2 Expansion 5
...
| --- | ---: | ---: | ---: |
| A1 | 900-1100 | 964 | 1099 |
| A2 | 1400-1600 | 1431 | 1598 |
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\ContentUtilities\TestTalkTopicPackages.ps1 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-5
```
...
- TalkTopics in API: 3701
- Vocabulary references: 93512
- Resolved vocabulary references: 93512
- Resolution: 100%
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\Server\Initialize-LocalServerContent.ps1 -ApiBaseUrl http://localhost:53945 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-5 -AdminApiKey local-dev-admin-api-key-change-me
```

Published batch:

- `darwin-deutsch-20260510155127461`
