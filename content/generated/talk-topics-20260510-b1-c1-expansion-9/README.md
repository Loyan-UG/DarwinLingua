# Darwin Deutsch Talk Topics B1-C1 Expansion 9
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\ContentUtilities\TestTalkTopicPackages.ps1 -ContentPath .\content\generated\talk-topics-20260510-b1-c1-expansion-9
```
...
- TalkTopics in API: 3001
- Vocabulary references: 80112
- Resolved vocabulary references: 80112
- Resolution: 100%
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\Server\Initialize-LocalServerContent.ps1 -ApiBaseUrl http://localhost:53945 -ContentPath .\content\generated\talk-topics-20260510-b1-c1-expansion-9 -AdminApiKey local-dev-admin-api-key-change-me
```

Published batch:

- `darwin-deutsch-20260510150919970`
...
A PostgreSQL custom-format dump was created outside the repository next to the solution folder:

- `D:\_Projects\DarwinLingua-DatabaseBackups\20260510-171157\darwinlingua_shared_20260510-171157.dump`
- Manifest: `D:\_Projects\DarwinLingua-DatabaseBackups\20260510-171157\backup-manifest.json`
