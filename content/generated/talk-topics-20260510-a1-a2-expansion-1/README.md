# Darwin Deutsch Talk Topics A1-A2 Expansion 1
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\ContentUtilities\TestTalkTopicPackages.ps1 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-1
```
...
- TalkTopics in API: 3301
- Vocabulary references: 87112
- Resolved vocabulary references: 87112
- Resolution: 100%
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\Server\Initialize-LocalServerContent.ps1 -ApiBaseUrl http://localhost:53945 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-1 -AdminApiKey local-dev-admin-api-key-change-me
```

Published batch:

- `darwin-deutsch-20260510153412081`
