# Darwin Deutsch Talk Topics B1-C1 Expansion 5
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\ContentUtilities\TestTalkTopicPackages.ps1 -ContentPath .\content\generated\talk-topics-20260510-b1-c1-expansion-5
```
...
- TalkTopics in API: 2151
- Vocabulary references: 56712
- Resolved vocabulary references: 56712
- Resolution: 100%
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\Server\Initialize-LocalServerContent.ps1 -ApiBaseUrl http://localhost:53945 -ContentPath .\content\generated\talk-topics-20260510-b1-c1-expansion-5 -AdminApiKey local-dev-admin-api-key-change-me
```

Published batch:

- `darwin-deutsch-20260510143910559`
