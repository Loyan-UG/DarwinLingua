# Darwin Deutsch Talk Topics A1-A2 Expansion 4
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\ContentUtilities\TestTalkTopicPackages.ps1 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-4
```
...
- TalkTopics in API: 3601
- Vocabulary references: 91912
- Resolved vocabulary references: 91912
- Resolution: 100%
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\tools\Server\Initialize-LocalServerContent.ps1 -ApiBaseUrl http://localhost:53945 -ContentPath .\content\generated\talk-topics-20260510-a1-a2-expansion-4 -AdminApiKey local-dev-admin-api-key-change-me
```

Published batch:

- `darwin-deutsch-20260510154702915`
