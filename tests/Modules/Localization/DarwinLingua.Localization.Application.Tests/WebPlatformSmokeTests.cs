...
public sealed class WebPlatformSmokeTests
{
    ...
    public void WebHost_ShouldExposeLearnerShellAdminAreaAndPwaAssets()
    {
        ...
        Assert.Contains("htmx.min.js", layoutSource, StringComparison.Ordinal);
        Assert.Contains("install-banner", layoutSource, StringComparison.Ordinal);
        Assert.Contains("curated workplace collections", homeViewSource, StringComparison.Ordinal);
        Assert.Contains("Featured collections", homeViewSource, StringComparison.Ordinal);
        ...
        Assert.Contains("data-word-detail-page", wordDetailViewSource, StringComparison.Ordinal);
        ...
        Assert.Contains("Your workspace", accountViewSource, StringComparison.Ordinal);
        ...
        Assert.Contains("Operational control center", adminViewSource, StringComparison.Ordinal);
        ...
        Assert.Contains("Review rollback warning", adminRollbackViewSource, StringComparison.Ordinal);
        Assert.Contains("Darwin Lingua Admin", adminLayoutSource, StringComparison.Ordinal);
        Assert.Contains("Practical German", appHeaderSource, StringComparison.Ordinal);
        Assert.Contains("aria-label=\"@T[\"Mobile\"]\"", mobileNavSource, StringComparison.Ordinal);
