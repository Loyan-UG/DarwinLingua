...
public sealed class WebTesterOperatorToolingTests
{
    ...
    public void WebTesterRunbook_ShouldDocumentBatchPremiumTooling()
    {
        ...
        Assert.Contains("RunBrevoReadinessCheck", externalActionPacketScript, StringComparison.Ordinal);
        Assert.Contains("Invoke-BrevoProductionReadinessCheck.ps1", externalActionPacketScript, StringComparison.Ordinal);
        Assert.Contains("-VerifyBrevoApi", externalActionPacketScript, StringComparison.Ordinal);
        Assert.Contains("-RequireRealDelivery", externalActionPacketScript, StringComparison.Ordinal);
        ...
        Assert.Contains("Start-Process", externalActionPacketScript, StringComparison.Ordinal);
        Assert.Contains("RedirectStandardOutput", externalActionPacketScript, StringComparison.Ordinal);
        Assert.Contains("brevo.accountApi", externalActionPacketScript, StringComparison.Ordinal);
